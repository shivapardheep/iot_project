...
class WorkStatus2 extends StatefulWidget {
  const WorkStatus2({Key? key}) : super(key: key);

  @override
  State<WorkStatus2> createState() => _WorkStatus2State();
}

class _WorkStatus2State extends State<WorkStatus2> {
