...
class SubSoilSix extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubSoilSix({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubSoilSix> createState() => _SubSoilSixState();
}

class _SubSoilSixState extends State<SubSoilSix> {
  var fetchGetData;
  var fetchPostData;
