...
class SoilSubPage extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SoilSubPage({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SoilSubPage> createState() => _SoilSubPageState();
}

class _SoilSubPageState extends State<SoilSubPage> {
  var fetchGetData;
  var fetchPostData;
