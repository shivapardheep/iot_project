...
class SubSoilOne extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubSoilOne({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubSoilOne> createState() => _SubSoilOneState();
}

class _SubSoilOneState extends State<SubSoilOne> {
  var fetchGetData;
  var fetchPostData;
