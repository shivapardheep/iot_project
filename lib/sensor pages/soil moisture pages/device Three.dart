...
class SubSoilThree extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubSoilThree({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubSoilThree> createState() => _SubSoilThreeState();
}

class _SubSoilThreeState extends State<SubSoilThree> {
  var fetchGetData;
  var fetchPostData;
