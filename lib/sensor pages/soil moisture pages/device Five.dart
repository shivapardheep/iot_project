...
class SubSoilFive extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubSoilFive({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubSoilFive> createState() => _SubSoilFiveState();
}

class _SubSoilFiveState extends State<SubSoilFive> {
  var fetchGetData;
  var fetchPostData;
