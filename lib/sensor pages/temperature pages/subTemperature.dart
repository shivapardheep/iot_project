...
class TempSubPage extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const TempSubPage({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<TempSubPage> createState() => _TempSubPageState();
}

class _TempSubPageState extends State<TempSubPage> {
  var fetchGetData;
  var fetchPostData;
