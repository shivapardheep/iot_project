...
class SubTempThree extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubTempThree({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubTempThree> createState() => _SubTempThreeState();
}

class _SubTempThreeState extends State<SubTempThree> {
  var fetchGetData;
  var fetchPostData;
