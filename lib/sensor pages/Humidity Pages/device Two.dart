...
class SubHumidityTwo extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubHumidityTwo({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubHumidityTwo> createState() => _SubHumidityTwoState();
}

class _SubHumidityTwoState extends State<SubHumidityTwo> {
  var fetchGetData;
  var fetchPostData;
