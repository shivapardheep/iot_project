...
class SubHumidityThree extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubHumidityThree(
      {Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubHumidityThree> createState() => _SubHumidityThreeState();
}

class _SubHumidityThreeState extends State<SubHumidityThree> {
  var fetchGetData;
  var fetchPostData;
