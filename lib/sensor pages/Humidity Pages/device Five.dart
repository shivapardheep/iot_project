...
class SubHumidityFive extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubHumidityFive(
      {Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubHumidityFive> createState() => _SubHumidityFiveState();
}

class _SubHumidityFiveState extends State<SubHumidityFive> {
  var fetchGetData;
  var fetchPostData;
