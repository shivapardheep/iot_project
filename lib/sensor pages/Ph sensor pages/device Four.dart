...
class SubPhFour extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubPhFour({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubPhFour> createState() => _SubPhFourState();
}

class _SubPhFourState extends State<SubPhFour> {
  var fetchGetData;
  var fetchPostData;
