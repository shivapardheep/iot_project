...
class SubPhTwo extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubPhTwo({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubPhTwo> createState() => _SubPhTwoState();
}

class _SubPhTwoState extends State<SubPhTwo> {
  var fetchGetData;
  var fetchPostData;
