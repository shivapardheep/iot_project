...
class SubPhOne extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubPhOne({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubPhOne> createState() => _SubPhOneState();
}

class _SubPhOneState extends State<SubPhOne> {
  var fetchGetData;
  var fetchPostData;
