...
class PhSubpage extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const PhSubpage({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<PhSubpage> createState() => _PhSubpageState();
}

class _PhSubpageState extends State<PhSubpage> {
  var fetchGetData;
  var fetchPostData;
