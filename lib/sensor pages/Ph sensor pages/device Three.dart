...
class SubPhThree extends StatefulWidget {
  ...
  const SubPhThree({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubPhThree> createState() => _SubPhThreeState();
}

class _SubPhThreeState extends State<SubPhThree> {
  var fetchGetData;
  var fetchPostData;
