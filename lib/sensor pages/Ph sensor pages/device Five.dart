...
class SubPhFive extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubPhFive({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubPhFive> createState() => _SubPhFiveState();
}

class _SubPhFiveState extends State<SubPhFive> {
  var fetchGetData;
  var fetchPostData;
