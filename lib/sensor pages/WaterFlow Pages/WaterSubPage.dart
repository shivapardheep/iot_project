...
class WaterSubPage extends StatefulWidget {
  ...
  const WaterSubPage({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<WaterSubPage> createState() => _WaterSubPageState();
}

class _WaterSubPageState extends State<WaterSubPage> {
  var fetchGetData;
  var fetchPostData;
