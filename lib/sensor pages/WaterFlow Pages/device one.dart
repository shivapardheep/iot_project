...
class SubWaterOne extends StatefulWidget {
  final String deviceId;
  final String sensor;

  const SubWaterOne({Key? key, required this.deviceId, required this.sensor})
      : super(key: key);

  @override
  State<SubWaterOne> createState() => _SubWaterOneState();
}

class _SubWaterOneState extends State<SubWaterOne> {
  var fetchGetData;
  var fetchPostData;
